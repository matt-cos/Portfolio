...
function matt_portfolio_scripts() {
	...
	wp_enqueue_script( 'matt_portfolio-navigation', get_template_directory_uri() . '/dist/js/scripts.min.js', array('jquery'), '876', true );

	wp_enqueue_script( 'matt_portfolio-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
